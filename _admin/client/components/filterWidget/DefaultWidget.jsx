...
class DefaultWidget extends Component {
  ...
  renderDoubleInputs() {
    ...
    const fromDate = this.renderInputElement(value1, (value) => this.onValueChange([value, value2]));
    const toDate = this.renderInputElement(value2, (value) => this.onValueChange([value1, value]));
